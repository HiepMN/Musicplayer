    ...
    songs: [
        {
            ...
            author: "The Weeknd",
            image: "./assets/img/Blinding lights.png",
            path: "./assets/music/The Weeknd - Blinding Lights (Official Audio).mp3",
        },
        {
            name: "Different Lives",
            author: "Fly By Midnight",
            image: "./assets/img/Different lives.png",
            path: "./assets/music/Different Lives.mp3",
        },
        {
            name: "A Good ChildHood",
            author: "Flora Cash",
            image: "./assets/img/A good childhood.png",
            path: "./assets/music/flora cash - A good childhood (Official Audio).mp3",
        },
        {
            name: "7 Years",
            author: "Lukas Graham",
            image: "./assets/img/7 years.png",
